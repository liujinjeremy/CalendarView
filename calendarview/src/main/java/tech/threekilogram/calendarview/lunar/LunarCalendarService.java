package tech.threekilogram.calendarview.lunar;
...
/**
 * @author Liujin 2019/3/1:17:24:57
 */
public class LunarCalendarService {
      ...
      /**
       * 农历部分假日
       * 这里去掉了"0715 中元节","0909 重阳节",
       **/
      private final static String[] lunarHoliday = new String[]{
          "0101 春节", "0115 元宵", "0505 端午", "0707 七夕",
          "0815 中秋", "1208 腊八", "1224 小年", "0100 除夕"
      };

      /**
       * 公历部分节假日
       * 这里去掉"0101 元旦","0312 植树","0315 消费者权益日","0501 劳动", "0504 青年","0512 护士","0701 建党", "0801 建军",
       **/
      ...
      private String getLunarDate (
          int year_log, int month_log, int day_log,
          boolean isday ) {
      ...
      public static void main ( String[] args ) {
            ...
            System.out.println( new LunarCalendarService().getLunarDate( 2019, 3, 1, false ) );
      }
}
